...
import { startCncResetScheduler } from "./services/cncResetScheduler.js";
...
app.use(
  cors({
    origin: [env.CLIENT_URL, "http://localhost:3001", "http://localhost:19006","https://crm.carltonedu.com"],
    credentials: true,
