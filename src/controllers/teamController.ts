...
export async function getTeams(
  ...
  try {
    ...
    sendSuccess(res, "Teams fetched successfully", result.teams, 200, result.pagination);
  } catch (err) {
    next(err);
  }
}
...
export async function getTeamLeads(
  ...
  try {
    ...
    sendSuccess(res, "Team leads fetched successfully", result.leads, 200, result.pagination);
  } catch (err) {
    next(err);
  }
}
...
export async function autoAssignTeamLeads(
  ...
  try {
    ...
    const result = await teamService.autoAssignTeamLeadsToMembers(req.params.id, leadIds);
    sendSuccess(res, `${result.assigned} lead(s) auto-assigned to team members`, result);
  } catch (err) {
    next(err);
  }
}
...
export async function assignLeadToMember(
  ...
  try {
    ...
    const result = await teamService.assignLeadToMember(teamId, leadId, memberId, performedById);
...
export async function getTeamLogs(
  ...
  try {
    ...
    sendSuccess(res, "Team logs fetched successfully", result.logs, 200, result.pagination);
  } catch (err) {
    next(err);
  }
}
